...
class Window(QtWidgets.QMainWindow):
    ...
    def search(self):
        ...
        self.results = rollstools.car_search(car)
        ...
        if type(self.results) is str: #in case of an exhibition of the error message
            ...
            dfs = rollstools.result_table(self.results[1], self.results[2], self.results[3], self.results[4], self.results[5], self.results[6], self.results[7], self.results[8], self.results[9])
